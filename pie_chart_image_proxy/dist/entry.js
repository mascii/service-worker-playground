...
var updateChart = function updateChart(query) {
  var escapedQuery = __WEBPACK_IMPORTED_MODULE_1_qs___default.a.stringify(__WEBPACK_IMPORTED_MODULE_1_qs___default.a.parse(query));
...
queryInput.addEventListener('input', function (e) {
  return updateChart(e.target.value);
});
